          ...
          <div className="min-w-0 flex-1 space-y-8">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    {/* --- Dropdown de Código de País (precisaria de JS para funcionar) --- */}
                    <button
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 20 15"
                      >
                        {/* Conteúdo do SVG da bandeira US */}
                        <rect
                          width="19.6"
                          height="14"
                          y=".5"
                    ...
                    {/* --- Conteúdo do Dropdown (precisaria de estado e lógica JS/React para funcionar) --- */}
                    <div
                      id="dropdown-phone-3"
                      className="z-10 hidden w-56 divide-y divide-gray-100 rounded-lg bg-white shadow dark:bg-gray-700"
                    >
                      {/* ... Itens do dropdown aqui (cada um com seu SVG de bandeira) ... */}
                    </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                {/* Adicione outras opções de entrega aqui, se necessário */}
              </div>
            </div>
          </div>{" "}
          {/* Fim da coluna principal */}
          {/* --- Resumo do Pedido (Coluna Lateral) --- */}
          {/* A coluna lateral não estava no seu HTML original, mas normalmente iria aqui */}
          {/* <div className="w-full space-y-4 lg:mt-0 lg:max-w-sm xl:max-w-md"> */}
          {/* ... Conteúdo do resumo do pedido ... */}
          {/* </div> */}
        </div>{" "}
        {/* Fim do layout flexível */}
      </form>
    </section>
  );
}
