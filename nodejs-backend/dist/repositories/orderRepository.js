...
class OrderRepository {
    ...
    getBestSellingProductsBySeller(sellerId) {
        return __awaiter(this, void 0, void 0, function* () {
            return db_1.default.orderItem.groupBy({
                by: ["productId"],
    ...
    getNewCustomersByMonth(sellerId) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield db_1.default.$queryRaw `SELECT DATE_TRUNC('month', MIN(o."createdAt")) AS month, COUNT(DISTINCT o."customerId") AS new_customers FROM "order" o JOIN "seller_order" so ON so."orderId" = o."id" WHERE so."sellerId" = ${sellerId} GROUP BY o."customerId" HAVING MIN(o."createdAt") >= NOW() - INTERVAL '6 months'`;
            return result.map((r) => ({
                month: r.month,
